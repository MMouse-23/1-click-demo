Function  LIB-Config-ISOurlData { 
  ...
  if ($datavar.Hypervisor -match "ESX"){
    ...
    $MoveAutoUrl = "https://dl.dropboxusercontent.com/s/ikugn9qyj8wp1y4/move-3.4.1.qcow2"
  }
  if ($debug -ge 2){
  ...
  if ($datavar.Hypervisor -match "ESX") {
    if ($region -match "www|Backup" ){
      ...
      $windows2016   = "https://dl.dropboxusercontent.com/s/48rqxg48txff7ad/Windows2016V4.vmdk"
      $VirtIO1_1_4ISO= "https://dl.dropboxusercontent.com/s/36qgacn06pzjd5r/Nutanix-VirtIO-1.1.4.iso"
      $sqlSERVER     = "https://dl.dropboxusercontent.com/s/pkl10yanijotjc6/MSSQL-2016V4.vmdk"
      ...
      $windows2016   = "http://$($ip)/data/Windows2016V4.vmdk"
  ...
  ## AHV URLS
    if ($region -match "www|Backup" ){
      ...
      $VirtIO1_1_4ISO= "http://$($ip)/data/Nutanix-VirtIO-1.1.4.iso"
      $sqlSERVER     = "http://$($ip)/data/MSSQL-2016V2.qcow2" 
      ...
      $VirtIO1_1_4ISO= "http://$($ip)/images/1-Click-Demo/Nutanix-VirtIO-1.1.4.iso"
      $sqlSERVER     = "http://$($ip)/images/1-Click-Demo/MSSQL-2016V2.qcow2"
