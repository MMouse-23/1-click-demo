...
/****** Object:  Table [dbo].[Queue]    Script Date: 15-10-2019 00:08:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Queue](
	...
	[QUEUEStatus] [varchar](max) NULL,
	[QUEUEValid] [varchar](max) NULL,
	[QUEUESource] [varchar](max) NULL,
	[ProcessingMode] [varchar](max) NULL,
